    ...
    <section className="songImage">
      ...
      <div className="songImage__bottom">
        <div className="songImage__bottom__left">
          ...
          <h2>Music News</h2>
          <p>
            Don't miss a beat with the latest Canadian music news, reviews,
            interviews, and releases from rising artists.
          </p>
        ...
        <div className="songImage__bottom__right">
          ...
          <h2>Our Programs</h2>
          <p>
            Waveland’s programs provide rising Canadian artists with performance
            opportunities across various events, concerts, and showcases in
